...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__2710890",
    appName: "liansheng-mini",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
Object.defineProperty(yin, "__esModule", { value: true });
...
function YIN(params) {
  ...
  var config = __assign$4(__assign$4({}, DEFAULT_YIN_PARAMS), params);
  ...
  return function YINDetector(float32AudioBuffer) {
    ...
    for (var t2 = 0; t2 < yinBufferLength; t2++) {
      yinBuffer[t2] = 0;
    }
    for (var t2 = 1; t2 < yinBufferLength; t2++) {
      for (var i = 0; i < yinBufferLength; i++) {
        var delta = float32AudioBuffer[i] - float32AudioBuffer[i + t2];
        yinBuffer[t2] += delta * delta;
      }
    }
    yinBuffer[0] = 1;
    yinBuffer[1] = 1;
    var runningSum = 0;
    for (var t2 = 1; t2 < yinBufferLength; t2++) {
      runningSum += yinBuffer[t2];
      yinBuffer[t2] *= t2 / runningSum;
    }
...
Object.defineProperty(amdf, "__esModule", { value: true });
...
function AMDF(params) {
  ...
  var config = __assign$3(__assign$3({}, DEFAULT_AMDF_PARAMS), params);
  ...
  return function AMDFDetector(float32AudioBuffer) {
    ...
    for (i = 0; i < maxShift; i++) {
      if (minPeriod <= i && i <= maxPeriod) {
        for (aux1 = 0, aux2 = i, t2 = 0, frames1 = [], frames2 = []; aux1 < maxShift - i; t2++, aux2++, aux1++) {
          frames1[t2] = float32AudioBuffer[aux1];
          frames2[t2] = float32AudioBuffer[aux2];
        }
...
Object.defineProperty(acf2plus, "__esModule", { value: true });
var DEFAULT_PARAMS = {
  sampleRate: 44100
};
function ACF2PLUS(params) {
  ...
  var config = __assign$2(__assign$2({}, DEFAULT_PARAMS), params);
  var sampleRate = config.sampleRate;
...
Object.defineProperty(dynamic_wavelet, "__esModule", { value: true });
...
function DynamicWavelet(params) {
  ...
  var config = __assign$1(__assign$1({}, DEFAULT_DYNAMIC_WAVELET_CONFIG), params);
  var sampleRate = config.sampleRate;
...
dynamic_wavelet.DynamicWavelet = DynamicWavelet;
var macleod = {};
...
Object.defineProperty(macleod, "__esModule", { value: true });
...
(function(exports2) {
  ...
  exports2.DEFAULT_FREQUENCIES_PARAMS = {
    tempo: 120,
    quantization: 4,
    sampleRate: 44100
  };
  function pitchConsensus(detectors, chunk) {
    ...
    if (pitches.length === 1) {
      ...
      return Math.pow(filtered2.reduce(function(t2, p) {
        return t2 * p;
      }, 1), 1 / filtered2.length);
    }
  }
  function frequencies2(detector, float32AudioBuffer, options) {
    if (options === void 0) {
      options = {};
    }
    var config = __assign2(__assign2({}, exports2.DEFAULT_FREQUENCIES_PARAMS), options);
  ...
  exports2.frequencies = frequencies2;
})(frequencies);
Object.defineProperty(lib, "__esModule", { value: true });
var yin_1 = yin;
lib.YIN = yin_1.YIN;
var amdf_1 = amdf;
lib.AMDF = amdf_1.AMDF;
var acf2plus_1 = acf2plus;
lib.ACF2PLUS = acf2plus_1.ACF2PLUS;
var dynamic_wavelet_1 = dynamic_wavelet;
lib.DynamicWavelet = dynamic_wavelet_1.DynamicWavelet;
var macleod_1 = macleod;
lib.Macleod = macleod_1.Macleod;
var frequencies_1 = frequencies;
lib.frequencies = frequencies_1.frequencies;
var _default = lib.default = {
  YIN: yin_1.YIN,
  AMDF: amdf_1.AMDF,
